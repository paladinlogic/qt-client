...
class QWebEnginePageProto : public QObject, public QScriptable
{
  ...
  public:
    ...
    Q_INVOKABLE void load(const QUrl & url) const;
    ...
    Q_INVOKABLE void printToPdf(const QString & filePath, const QPageLayout & pageLayout = QPageLayout(QPageSize(QPageSize::A4), QPageLayout::Portrait, QMarginsF()));
    Q_INVOKABLE void printToPdf(std::function<void(QByteArray)> resultCallback, const QPageLayout & pageLayout = QPageLayout(QPageSize(QPageSize::A4), QPageLayout::Portrait, QMarginsF()));
    ...
    Q_INVOKABLE void runJavaScript(const QString & scriptSource, quint32 worldId, std::function<void(QVariant)> resultCallback);
